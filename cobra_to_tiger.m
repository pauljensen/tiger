...
%   'reactions_only'  Convert only reactions; do not attach genes or GPR to
%                     TIGER model. (default = false)

p = inputParser;
p.addParamValue('add_gpr',true);
p.addParamValue('fast_gpr',false);
p.addParamValue('reactions_only',false);
